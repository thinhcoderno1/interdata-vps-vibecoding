...
export const faqs = [
  ...
  { group: 'People Also Ask', question: 'Băng thông không giới hạn có nghĩa là tốc độ luôn tối đa?', answer: 'Không. “Unlimited Bandwidth” nghĩa là không giới hạn tổng dung lượng truyền tải theo tháng trong điều kiện sử dụng của gói; tốc độ tức thời vẫn bị giới hạn bởi network port. Các gói tạm thời đang hiển thị port 300–400 Mbps, nên tốc độ thực tế còn phụ thuộc tuyến mạng, máy người dùng và tải trên VPS.' },
  ...
  { group: 'Trước khi mua', question: 'Giá trên bảng đã là chi phí cuối cùng và giá gia hạn có giữ nguyên không?', answer: 'Hãy kiểm tra tổng tiền, chu kỳ thanh toán và các tùy chọn bổ sung tại trang đặt hàng trước khi trả tiền. Giá gia hạn của VPS Vibe Coding sẽ theo chính sách được công bố khi sản phẩm triển khai chính thức; website không cam kết “gia hạn không đổi giá”. License Windows, control panel, IP bổ sung hoặc dịch vụ quản trị có thể phát sinh phí nếu bạn chọn thêm.' },
];
