      ...
      <div className="container hero-grid">
        <div>
          ...
          <div className="hero-actions">
            <a className="btn primary" href="#dangky">Dùng thử 7 ngày miễn phí</a>
            <a className="btn ghost" href="#dangky">Nhận tư vấn chọn gói</a>
          </div>
          <div className="ticks"><span>Tự cài đặt sẵn</span><span>Có domain dùng ngay</span><span>Hỗ trợ 24/7</span><span>Hủy bất cứ lúc nào trong 7 ngày</span></div>
        </div>
